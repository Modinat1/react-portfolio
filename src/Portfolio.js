    ...
    <section id="about">
      ...
      <div className="about">
        <div className="profile-info" data-aos="fade-right" data-aos-duration="2000">
           <p>
            I'm Modinat, a Front-end developer. I'm skilled in NextJS, TypeScript, React, React Native, Context API, Redux Tool Kit, Javascript, Html, Css, Tailwind, SQL, python
          </p>
          <p>
